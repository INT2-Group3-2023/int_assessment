...
history = model.fit(training_ds, validation_data = validation_ds, epochs = 300, verbose=2, callbacks = [model_checkpoint_callback, reduce_lr])

file = open('less_layers.txt', 'w')
